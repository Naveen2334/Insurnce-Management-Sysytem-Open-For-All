...
<%@ page import="com.jsp.insurence_management.dto.*,java.util.ArrayList"%>
<%
...
<body>
	...
	<div class="content">
		...
		<form action="InsuranceController" method="post"
			name="viewpolicyform1" class="basic-grey"
			onSubmit="return View_policy_mandatory()">
			<h1>View Policies</h1>
		...
		%>
		<script>
			alert('No policy available for provided customer Id. Try again.');
