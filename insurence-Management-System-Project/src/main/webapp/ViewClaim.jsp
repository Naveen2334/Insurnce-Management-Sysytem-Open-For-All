...
<body>
	...
	<div class="content">
		...
		<form action="ClaimController" method="post" name="healthpolicyform"
			...
			<center>
				<input type="submit" value="Open Claims" />
			</center>
		</form>
		...
		<form action="ClaimController" method="post" name="healthpolicyform"
			...
			<center>
				<input type="submit" value="Approve Claims" />
			</center>
		</form>
		...
		<form action="ClaimController" method="post" name="healthpolicyform"
			...
			<center>
				<input type="submit" value="Reject Claims" />
			</center>
		</form>
		<br> <br>
		<%
		...
		<br>
		<h1 align="center"><%=(request.getAttribute("claimStatus").toString())%>&nbsp;Claims
		</h1>
			...
			<tr>
				...
				<form action="rejectView.jsp" method="post">
					...
					<td><button onclick="display()"
							...
							style="background-color: red; color: white;" <%}%> />Reject
						</button></td>
				</form>
			</tr>
